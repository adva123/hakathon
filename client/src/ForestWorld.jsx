...
//           <meshStandardMaterial color={'#FF00FF'} map={grassTex || undefined} roughness={1} metalness={0} />
//         </mesh>
...
//                 {/* Frosted-glass room volume (teaser) - HIDDEN to prevent black box appearance */}
//                 {/* COMMENTED OUT - was causing black box visual bug
...
//                   {/* Energy screen - DISABLED to debug black box issue */}
//                   {/* COMMENTED OUT - suspected to cause black screen
