...
//         {/* Cave shell - TEST: Changed to bright red */}
//         <mesh position={[0, floorY + 2.4, 0]}>
//           <sphereGeometry args={[18, 48, 32]} />
//           <meshStandardMaterial color={'#ff0000'} emissive={'#ff0000'} emissiveIntensity={2} roughness={1} metalness={0} side={THREE.BackSide} />
//         </mesh>
...
//         {/* Shop interior shell - TEST: Changed to bright green */}
//         <mesh position={[0, floorY + 3, 0]}>
//           <sphereGeometry args={[20, 48, 32]} />
//           <meshStandardMaterial color={'#00ff00'} emissive={'#00ff00'} emissiveIntensity={2} roughness={0.8} metalness={0.1} side={THREE.BackSide} />
//         </mesh>
