...
// import { getOwnedRobots, addOwnedRobot } from '../api/userApi';
...
//   // ✅ SINGLE shopState declaration - removed duplicate
...
//   // Sync owned robots from DB when userId changes
//   useEffect(() => {
//     if (userId) {
//       getOwnedRobots(userId).then(res => {
//         if (res.data?.robots) {
//           setShopState(prev => ({ ...prev, ownedRobots: res.data.robots }));
//         }
//       });
//     }
//   }, [userId]);
...
//   // ✅ REMOVED DUPLICATE shopState DECLARATION HERE
...
//   const buyRobot = useCallback(async ({ robotId, price, useCoins = false }) => {
//     if (!robotId || typeof price !== 'number' || !userId) return { ok: false, reason: 'invalid' };
//     let allowed = false;
//     if (useCoins) {
//       setCoins((c) => {
//         if (c >= price) {
...
//     // Update DB
//     await addOwnedRobot(userId, robotId);
//     setShopState((prev) => {
